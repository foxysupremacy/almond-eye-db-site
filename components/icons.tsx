...
/** Flat Timer / Stopwatch Icon for duration stats */
export function TimerIcon({ className = "h-4 w-4", ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <line x1="12" x2="12" y1="14" y2="9" />
      <circle cx="12" cy="14" r="8" />
    </svg>
  );
}

/** Flat Checkered / Finish Flag Icon for distance stats */
export function FlagIcon({ className = "h-4 w-4", ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Flat Search / Magnifying Glass Icon */
...
/** Flat Edit / Pencil Icon */
export function EditIcon({ className = "h-4 w-4", ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Flat Clipboard Icon */
export function ClipboardIcon({ className = "h-4 w-4", ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Flat Alert / Warning Triangle Icon */
export function AlertTriangleIcon({ className = "h-4 w-4", ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Flat Star Icon (Filled or Outlined) */
...
/** 5-Star Rating strip using crisp SVG Stars */
export function StarRating({
  ...
  return (
    <div className={className} aria-label={`${stars} out of ${maxStars} stars`}>
...
/** Flat Target / Crosshair / Bullseye Icon */
